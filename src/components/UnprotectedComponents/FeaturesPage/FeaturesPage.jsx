  ...
  return (
    <div>
      ...
      <div className="featurePageDiv">
        <h1>Features</h1>
        <p>
          <AddCircleOutlineIcon className="featurePageIcons" fontSize="large" />{' '}
          <b className="featurePageWords">Search</b> your healthcare services by
          CPT* or description
        </p>
        <p>
      ...
      <div className="featureDetailsDiv">
        ...
        <p>
          ...
          <b className="featurePageWords">MyMedVita</b> allows you to see prices
          that providers will be reimbursed for and the provider might be
          willing to service you at that rate.
        </p>
      </div>
      <div className="finePrint">
        <i>
          Note: *Providers* are not necessarily the medical clinicians, meaning{' '}
          <u>a clinician might not have control over the prices</u> but rather
          it might be the administrator staff negotiating those prices with
          insurers.
        </i>
      </div>
    </div>
